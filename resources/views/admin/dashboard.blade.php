...
<div class="col-sm-6 col-md-3 grid-margin">
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Tuation Fee</h2>
                  <p style="font-family: cursive; font-size:25px; font-weight:bold; text-align:center;">Monthly: 2500tk</p>
                </div>
                <div class="dashboard-chart-card-container">
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <p style="font-family: cursive; font-size:25px; font-weight:bold; text-align:center;">82%</p>
                </div>
                <div class="dashboard-chart-card-container">
              ...
              <div class="row">
                <div class="col-12 grid-margin d-flex align-items-stretch">
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-twitter"><p class="mb-0">MBA</p></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="task-cards selected">
                    ...
                    <div class="wrapper d-flex flex-row align-items-end justify-content-between">
                      <div class="amount d-flex flex-column">
                        <small>Time is:</small>
                        <small class="value"><?php echo date("h:i") ?></small>
                      </div>
                      <div class="status d-flex flex-column">
                        <small>To day is:</small>
                        <small class="value"><?php echo date("Y/m/d") ?></small>
                      </div>
